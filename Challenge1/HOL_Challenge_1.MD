...
1. Once the Compute Instance has been provisioned, click on the Jupyter Lab environment link to be taken to an interactive Jupyter Lab environment where we can use Notebooks. 
