...
1. Upload the Challenge files from this repo. This can be done manually or by using GitHub. 
    ...
    If you're using GitHub, start up a new Terminal in your Jupyter Lab environment. Change directory into our Users folder. Here, you'll need to clone your forked repo using the command `git clone <forked repo URL>`. You should see your files uploaded to your Jupyter environment.
